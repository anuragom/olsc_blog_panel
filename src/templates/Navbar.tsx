...
const Navbar: FC = () => {
  ...
  return (
    <div className="w-full mb-12 font-sans select-none">
      {/* Top Bar */}
      <div className="fixed top-0 left-0 w-full bg-[#0D5BAA] flex items-center justify-between px-4 md:px-10 py-2 text-white text-sm z-50 shadow-md border-b-2 border-white">
        <div className="flex items-center gap-4 ml-4 md:ml-16">
          <div className="flex items-center gap-2 cursor-not-allowed opacity-90">
            <Image src={callIcon} alt="Phone" width={16} height={16} />
            <span className="text-white text-sm md:text-base font-normal font-roboto">
              +91 7669-005-500
            </span>
        ...
        <div className="hidden md:flex mr-4 md:mr-16 gap-3">
          <span className="hover:text-gray-300 cursor-not-allowed">
            <FaFacebookF />
          </span>
          <span className="hover:text-gray-300 cursor-not-allowed">
            <FaWhatsapp />
      ...
      <nav className="fixed top-[41px] left-0 w-full bg-white shadow-md py-5 px-6 md:px-12 flex items-center justify-between z-40">
        ...
        <div className="hidden lg:flex flex-1 items-center justify-center">
          <div className="flex items-center gap-8 xl:gap-10">
            {navItems.map((item, index) => (
              <div
                key={index}
                className="relative group cursor-not-allowed opacity-90"
              >
                <button
                  className="text-[#001f39] text-base xl:text-lg font-normal font-roboto flex items-center gap-1 whitespace-nowrap"
                  disabled
                >
                  {item.name}
                  {(item.name === "About Us" ||
        ...
        <div className="hidden lg:flex items-center gap-3 flex-shrink-0 ml-4">
          <button
            className="border border-[#e11f26] text-[#e11f26] text-base xl:text-lg font-medium font-roboto px-4 xl:px-5 py-3 rounded hover:bg-[#e11f26] hover:text-white transition-colors whitespace-nowrap cursor-not-allowed opacity-90"
            disabled
          >
            Contact Us
          </button>
          <button
            onClick={logout}
            className="border border-[#e11f26] text-[#e11f26] text-base xl:text-lg font-medium font-roboto px-4 xl:px-5 py-3 rounded hover:bg-[#e11f26] hover:text-white transition-colors whitespace-nowrap opacity-90"
          >
            Logout
          </button>
        </div>
        ...
        <button
          className="lg:hidden text-[#001f39] p-2 cursor-not-allowed opacity-60"
          disabled
        >
          <FaBars size={28} />
        </button>
